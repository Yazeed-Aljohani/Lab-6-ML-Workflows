...
**Explanation:** The autoplot shows cross-validated RMSE and R² for each model. We select the best model based on R².
...
**Explanation:** This step shows model performance across resamples. We choose the model with the highest R².
